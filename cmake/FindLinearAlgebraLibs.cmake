...
elseif (UNIX)
    ...
    if (MKL_FOUND)
        if (LINK_STATIC)
            string (REPLACE ";" " " QUEST_LAPACK_LIBRARIES "${MKL_LIBRARIES}")
            set (QUEST_LAPACK_LIBRARIES "-Wl,--start-group ${QUEST_LAPACK_LIBRARIES} -Wl,--end-group -lpthread -lgomp -lm -ldl")
        else ()

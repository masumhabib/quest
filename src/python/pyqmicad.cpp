...
BOOST_PYTHON_MODULE(qmicad)
{
    ...
    class_<NegfEloop, shared_ptr<NegfEloop>, noncopyable>("NegfEloop", 
        ...
        .def("enableI1", &NegfEloop::enableI1, NegfEloop_enableI1())
        .def("enableI1sx", &NegfEloop::enableI1sx, NegfEloop_enableI1sx())
        .def("enableI1sy", &NegfEloop::enableI1sy, NegfEloop_enableI1sy())
        .def("enableI1sz", &NegfEloop::enableI1sz, NegfEloop_enableI1sz())
    ;

...
${OBJECTDIR}/src/qm/kp/genKpAtoms.o: src/qm/kp/genKpAtoms.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/qm/kp/genKpAtoms.o src/qm/kp/genKpAtoms.cpp
...
${OBJECTDIR}/src/utils/stringutils.o: src/utils/stringutils.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/utils/stringutils.o src/utils/stringutils.cpp

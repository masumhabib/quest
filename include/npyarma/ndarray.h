 ...
 * ndarray (PyArrayObject*) and interface at the same time.
 *
...
//   * bp::object). We check the input object to assure it is a valid
//   * ndarray. An exception may be thrown otherwise.
//   */
//  void typeinfo_ndarray (const bp::object& o,
//      typeinfo& i);
//
//  /**
...
//   * object "o".
//   */
//  void typeinfo_ndarray_ (const bp::object& o,
//      typeinfo& i);
//
//  /**
//   * @brief Checks if an array-like object is convertible to become a NumPy
//   * ndarray (bp::numeric::array). If so, write the typeinfo
...
//   */
//  convert_t convertible(bp::object array_like,
//      typeinfo& info, bool writeable=true,
//      bool behaved=true);
//
//  /**
...
//      const typeinfo& info, bool writeable=true,
//      bool behaved=true);
//
//  /**
...
//   */
//  convert_t convertible_to (bp::object array_like,
//      bp::object dtype_like, bool writeable=true,
//      bool behaved=true);
//
//  /**
...
//      bool has_type(ElementType eltype) const; ///< matches
//
//      /**
//       * @brief Returns the current element type
//       */
//      ElementType eltype() const;
//
//      /**
...
//
//      /**
//       * @brief Returns a bp representation of this object - maybe
//       * None.
//       */
//      inline bp::object self() const { return m_self; }
//
//      /**
...
//  };
//
//  class py_array: public interface {
//
//    public: //api
//
//      /**
...
//       */
//      py_array(bp::object array_like,
//              bp::object dtype_like);
//
//      /**
//       * @brief Builds a new array copying the data of an existing buffer.
//       */
//      py_array(const interface& buffer);
//
//      /**
//       * @brief Builds a new array by referring to the data of an existing
//       * buffer.
//       */
//      py_array(boost::shared_ptr<interface> buffer);
//
//      /**
//       * @brief Builds a new array from scratch using the typeinfo. This array
//       * will be a NumPy ndarray internally.
//       */
//      py_array(const typeinfo& info);
//
//      template <typename T>
//      py_array(ElementType t, T d0) {
//        set(typeinfo(t, (T)1, &d0));
//      }
//      template <typename T>
//      py_array(ElementType t, T d0, T d1) {
//        T shape[2] = {d0, d1};
//        set(typeinfo(t, (T)2, &shape[0]));
//      }
//      template <typename T>
//      py_array(ElementType t, T d0, T d1, T d2) {
//        T shape[3] = {d0, d1, d2};
//        set(typeinfo(t, (T)3, &shape[0]));
//      }
//      template <typename T>
//      py_array(ElementType t, T d0, T d1, T d2, T d3) {
//        T shape[4] = {d0, d1, d2, d3};
//        set(typeinfo(t, (T)4, &shape[0]));
//      }
//      template <typename T>
//      py_array(ElementType t, T d0, T d1, T d2, T d3, T d4)
//      {
//        T shape[5] = {d0, d1, d2, d3, d4};
//        set(typeinfo(t, (T)5, &shape[0]));
//      }
//
//      /**
//       * @brief D'tor virtualization
...
//       */
//      virtual void set(const interface& buffer);
//
//      /**
//       * @brief Refers to the data of another buffer.
//       */
//      virtual void set(boost::shared_ptr<interface> buffer);
//
//      /**
...
//       */
//      virtual bp::object copy
//        (const bp::object& dtype = bp::object());
//
//      /**
...
//       */
//      virtual bp::object pyobject();
//
//      /**
//       * @brief type cast operator converting this object into a bp::object
//       */
//      operator bp::object(){return pyobject();}
//
//      /**
...
//       */
//      ndarray(const typeinfo& info);
//
//      template <typename T>
//      ndarray(ElementType t, T d0)
//        : px(new py_array(t, d0)) { }
//      template <typename T>
//      ndarray(ElementType t, T d0, T d1)
//        : px(new py_array(t, d0, d1)) { }
//      template <typename T>
//      ndarray(ElementType t, T d0, T d1, T d2)
//        : px(new py_array(t, d0, d1, d2)) { }
//      template <typename T>
//      ndarray(ElementType t, T d0, T d1, T d2, T d3)
//        : px(new py_array(t, d0, d1, d2, d3)) { }
//      template <typename T>
//      ndarray(ElementType t, T d0, T d1, T d2, T d3, T d4)
...
//       */
//      virtual bp::object self();
//
//      /**
//       * @brief type cast operator converting this object into a bp::object
//       */
//      operator bp::object(){return self();}
//
//      /**
...
//       * to copy the data. Otherwise, we just refer.
//       */
//      const_ndarray(bp::object array_like);
//
//      /**
//       * @brief D'tor virtualization
//       */
...
//        switch(info.dtype){
//          // boolean types
//          case t_bool: return cast<T>(bz<bool,N>());
//
//          // integral types
//          case t_int8: return cast<T>(bz<int8_t,N>());
//          case t_int16: return cast<T>(bz<int16_t,N>());
//          case t_int32: return cast<T>(bz<int32_t,N>());
//          case t_int64: return cast<T>(bz<int64_t,N>());
//
//          // unsigned integral types
//          case t_uint8: return cast<T>(bz<uint8_t,N>());
//          case t_uint16: return cast<T>(bz<uint16_t,N>());
//          case t_uint32: return cast<T>(bz<uint32_t,N>());
//          case t_uint64: return cast<T>(bz<uint64_t,N>());
//
//          // floating point types
//          case t_float32: return cast<T>(bz<float,N>());
//          case t_float64: return cast<T>(bz<double,N>());
//          case t_float128: return cast<T>(bz<long double,N>());
//
//          // complex types
//          case t_complex64: return cast<T>(bz<std::complex<float>,N>());
//          case t_complex128: return cast<T>(bz<std::complex<double>,N>());
//          case t_complex256: return cast<T>(bz<std::complex<long double>,N>());
//
